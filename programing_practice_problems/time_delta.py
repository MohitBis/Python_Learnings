...
view this new post on their news feed. Users can also see exactly when the post was published, i.e, how many hours, minutes or seconds ago.
...
Each testcase contains 2 lines, representing t1 time  and t2 time .
